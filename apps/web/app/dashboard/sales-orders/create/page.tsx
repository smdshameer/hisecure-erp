...
export default function CreateSalesOrderPage() {
    ...
    const [items, setItems] = useState([
        { productId: '', quantity: 1, price: 0, discount: 0, taxRate: 0, description: '' }
    ]);
    ...
    const handleItemChange = (index: number, field: string, value: any) => {
        ...
        if (field === 'productId') {
            ...
            if (prod) {
                currentItem.price = prod.price || 0;
    ...
    const addItem = () => {
        setItems([...items, { productId: '', quantity: 1, price: 0, discount: 0, taxRate: 0, description: '' }]);
    };
        ...
        try {
            ...
            const payload = {
                ...
                items: items.map(i => ({
                    ...
                    lineTotal: (Number(i.quantity) * Number(i.price)) // Approximate, backend should validate
                }))
            };
        ...
        <div className={styles.container}>
            ...
            <form onSubmit={handleSubmit} className={styles.form} style={{ maxWidth: '900px', background: 'white', padding: '2rem', borderRadius: '8px' }}>
                ...
                <div className={styles.actions}>
                    <button type="submit" className="btn btn-primary" style={{ padding: '0.75rem 1.5rem', background: 'var(--primary-color, #0070f3)', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>Create Order</button>
                </div>
