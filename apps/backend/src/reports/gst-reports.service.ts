  ...
  async getGstr3b(month: number, year: number) {
    ...
    return {
      outwardSupplies: {
        ...
        totalTax:
          (Number(sales._sum.cgst) || 0) +
          (Number(sales._sum.sgst) || 0) +
          (Number(sales._sum.igst) || 0),
      },
      itcAvailable: {
        // Input Tax Credit
        ...
        totalTax:
          (Number(purchases._sum.cgst) || 0) +
          (Number(purchases._sum.sgst) || 0) +
          (Number(purchases._sum.igst) || 0),
      },
      taxPayable: {
        cgst: Math.max(
          0,
          (Number(sales._sum.cgst) || 0) - (Number(purchases._sum.cgst) || 0),
        ),
        sgst: Math.max(
          0,
          (Number(sales._sum.sgst) || 0) - (Number(purchases._sum.sgst) || 0),
        ),
        igst: Math.max(
          0,
          (Number(sales._sum.igst) || 0) - (Number(purchases._sum.igst) || 0),
        ),
      },
    };
  }
